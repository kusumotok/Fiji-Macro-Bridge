...
`Claude Desktop -> MCP -> server/fiji_mcp_macro.py -> TCP:5048 -> FijiMacroBridge.java -> Fiji GUI`
...
- `server/fiji_mcp_macro.py`
- `server/requirements.txt`
- `server/requirements-build.txt`
- `server/fiji_mcp_macro.spec`
- `README.md`
- `SPEC.md`
- `plugin/pom.xml`
...
- 生成物は `Fiji_Macro_Bridge.jar`
- `server/requirements.txt` は `mcp>=1.0.0`

## Claude Desktop 設定

- `command` は `python`
- `args` は `["path/to/Fiji_Macro_Bridge/server/fiji_mcp_macro.py"]`
